...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark text-bodydark bg-boxdark-2': darkMode === true }">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                <a href="index.html">
                    <img src="{{ asset('asset/admin/src/images/logo/logo.svg') }}" alt="Logo" />
                </a>
                                    ...
                                    <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                        <li>
                                            <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                                                href="index.html"
                                                :class="page === 'ecommerce' && '!text-white'">eCommerce</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- Dropdown Menu End -->
                                ...
                                <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                    ...
                                    :class="{
                                        'bg-graydark dark:bg-meta-4': (selected === 'UiElements') || (
                                            page === 'alerts' || page === 'buttons' || page === 'card' ||
                                            page === 'tabs' || page === 'modals')
                                    }">
                                    <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
                    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
                        ...
                        <a class="block flex-shrink-0 lg:hidden" href="index.html">
                            <img src="{{ asset('asset/admin/src/images/logo/logo-icon.svg') }}" alt="Logo" />
                        </a>
                    </div>
                                    ...
                                    <ul class="flex h-auto flex-col overflow-y-auto">
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                ...
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('asset/admin/src/images/user/user-02.png') }}"
                                                        alt="User" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                href="messages.html">
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('asset/admin/src/images/user/user-01.png') }}"
                                                        alt="User" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                href="messages.html">
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('asset/admin/src/images/user/user-03.png') }}"
                                                        alt="User" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="flex gap-4.5 border-t border-stroke px-4.5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                                href="messages.html">
                                                <div class="h-12.5 w-12.5 rounded-full">
                                                    <img src="{{ asset('asset/admin/src/images/user/user-04.png') }}"
                                                        alt="User" />
                                                </div>
    ...
    <!-- ===== Page Wrapper End ===== -->
    <script defer src="{{ asset('asset/admin/bundle.js') }}"></script>
</body>
